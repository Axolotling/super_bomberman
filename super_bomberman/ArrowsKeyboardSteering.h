...
public:
	...
	std::list<Action> determine_action() override
	{
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Up))
		{
			...
			{
				//add communicate
				action_log->push_communicate(action_log->getCommunicate(ActionLog::key_up_pressed));
		...
		else
		{
			...
			{
				action_log->push_communicate(action_log->getCommunicate(ActionLog::key_up_released));
			}
		...
		if (sf::Keyboard::isKeyPressed(sf::Keyboard::Down))
		{
			...
			{
				//add communicate
				action_log->push_communicate(action_log->getCommunicate(ActionLog::key_down_pressed));
		...
		else
		{
			...
			{
				action_log->push_communicate(action_log->getCommunicate(ActionLog::key_down_released));
			}
